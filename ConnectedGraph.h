...
/**
 * Class that represents a ConnectedGraph and its entire structure
 */
    class ConnectedGraph {
        /**
         * @var nodes - a vector containing Node type struct that includes all nodes of current ConnectedGraph
         */
        vector<Node> nodes;
        /**
    ...
    public:
        /**
         * Main constructor of the class ConnectedGraph
        ...
        /**
         * Function that disables all nodes in current ConnectedGraph
         * Time Complexity: O(V), which V is the number of Nodes
         */
        void disableAllAirports();
        /**
         * Function that disables a certain airline in all nodes of the current ConnectedGraph
         * Time Complexity: O(V), which V is the number of Nodes
         */
        void disableAirline(const string &airline);
        /**
         * Function that activates a certain airline in all nodes of the current ConnectedGraph
         * Time Complexity: O(V), which V is the number of Nodes
         */
        void activateAirline(const string &airline);
        /**
         * Function that activates all nodes in current ConnectedGraph
         * Time Complexity: O(V), which V is the number of Nodes
         */
